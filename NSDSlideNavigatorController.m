...
@interface NSDSlideNavigationController() <UIGestureRecognizerDelegate>
...
@implementation NSDSlideNavigationController
...
static NSDSlideNavigationController *singletonInstance;
...
- (BOOL)shouldDisplayMenu:(Menu)menu forViewController:(UIViewController *)vc
{
    if (menu == MenuRight)
    {
        if ([vc respondsToSelector:@selector(slideNavigationControllerShouldDisplayRightMenu)] &&
            [(UIViewController<NSDSlideNavigationControllerDelegate> *)vc slideNavigationControllerShouldDisplayRightMenu])
        {
            return YES;
        }
    }
    if (menu == MenuLeft)
    {
        if ([vc respondsToSelector:@selector(slideNavigationControllerShouldDisplayLeftMenu)] &&
            [(UIViewController<NSDSlideNavigationControllerDelegate> *)vc slideNavigationControllerShouldDisplayLeftMenu])
        {
            return YES;
        }
    }
...
- (void)setMenuRevealAnimator:(id<NSDSlideNavigationContorllerAnimator>)menuRevealAnimator
{
