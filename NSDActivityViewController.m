...
@interface NSDActivityViewController (){
    NSMutableArray<NSDNewsRssEntry *> * allRssEntry;}
@end

@implementation NSDActivityViewController
...
-(void)startView{
    ...
    if(_privateSelfUserFeed){
        ...
        [self setTitle:[title stringByAppendingString:@"'s activity"]];
    }
    else{
